...
var uncurryThis$l = NATIVE_BIND$1 && bind.bind(call$8, call$8);
...
var un$DateToString = uncurryThis$3(DatePrototype[TO_STRING$1]);
...
var qrCode = { generateQRCode, getQRCodeContent: helper.prepareContent };
